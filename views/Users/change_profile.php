...
/*
                                    ...
                                    */?>
                                    <div class="text-center">
                                        <img class="profile-user-img img-fluid img-circle" src="<?php echo $image->image ?>" alt="User profile picture" style=" height: 100px; width: 100px  ;border: 1px solid rgba(15,80,36,0.41) ">

                                        <input required type="file" name="profileImage" accept="image/x-png,image/gif,image/jpeg">
                                        <br>
                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane active" id="settings">
                                        <form class="form-horizontal" action="../process/user_process.php" method="post">
