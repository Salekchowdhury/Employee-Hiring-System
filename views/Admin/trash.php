            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <table id="example2" class="table table-bordered table-hover">
                        ...
                        <tbody>
                        <?php
                        $datas = $datamanipulation->viewAllDeleteAccount();
                        $s=1;
                        if($datas){
                            foreach ($datas as $data){
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a style="color: white" href="../../views/process/admin_process.php?recovery_id=<?php echo $data->user_id?>" title="Confim" class=" btn btn-primary btn-outline-success "><i class="  fas fa-check-circle"></i> RECOVERY</a>
                                        <a style="color: white"  href="../../views/process/admin_process.php?delete_admin_id=<?php echo $data->user_id?>" title="Delete" class="btn btn-danger  btn-outline-success "><i class="fas fa-trash"></i> DELETE</a>
