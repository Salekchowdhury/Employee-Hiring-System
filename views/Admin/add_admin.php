                        ...
                        <div style="border-radius: 8px; border: 2px solid;     border-color: #a71d2a; box-shadow: 5px 10px 10px 2px black" class="tab-pane ">
                            <form class="form-horizontal" action="../process/admin_process.php" method="post" enctype="multipart/form-data">
                                ...
                                <div style="padding: 10px" class="form-group row">
                                    ...
                                    <div class="col-6">
                                        <label  class="col-sm-6 col-form-label"><strong  >Profession:</strong></label>
                                        <div class="col-sm-10">
                                            <input required class="form-control" name="profession" value="">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <label  class="col-sm-4 col-form-label"><strong  >Bio:</strong></label>
                                        <div class="col-sm-10">
                                            <input required class="form-control" name="bio" value="">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <label  class="col-sm-6 col-form-label"><strong  >password:</strong></label>
                                        <div class="col-sm-10">
                   ...
                   <div class="card">
                       ...
                       <div class="card-body">
                           ...
                           <table id="sohag1" class="table table-bordered table-hover">
                               ...
                               <tbody>
                              <?php
                              $allAdmin=$datamanipulation->showAllAdmin();
                              $s=1;
                              if($allAdmin){
                                  foreach ($allAdmin as $list){
                                      ?>
                                      <tr>
                                          <td><?php echo $s?></td>
                                          ...
                                          <td>
                                              ...
                                              <a href="../process/admin_process.php?delete_admin_id=<?php echo $list->user_id?>" title="delete" class="btn btn-danger"><i class="fas fa-trash" aria-hidden="true"></i></a>
