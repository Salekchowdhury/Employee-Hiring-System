        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview">
                        <a href="emergency_cel.php" class="nav-link">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="row">
                        ...
                        <div class="col-md-3">
                            <form role="form" action="../../views/process/admin_process.php" method="post" enctype="multipart/form-data">
                            <!-- Profile Image -->
                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane active" id="settings">
                                        <form class="form-horizontal" action="../../views/process/admin_process.php" method="post">
