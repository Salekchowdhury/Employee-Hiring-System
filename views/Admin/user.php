...
<head>
    ...
    <link rel="stylesheet" href="../../contents/plugins/datatables-bs4/css/dataTables.bootstrap4.css">
...
<div class="wrapper">
    ...
    <div class="content-wrapper wow slideInDown" data-wow-duration= "1s">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table id="sohag1" class="table table-bordered table-hover">
                            ...
                            <tbody>
                            <?php
                            $datas = $datamanipulation->viewAllUser();
                            if($datas){
                                $s=1;
                                foreach ($datas as $data){
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="<?php echo $data->image?>" height="90px" width="90px"></td>
                                        <td>

                                            <a href="../../views/Admin/user_profile.php?view_building_woner_profile_by_email=<?php echo $data->user_id ?>"title="View Profile" <i class=" btn btn-success far fa-eye-slash" aria-hidden="true" style="padding-left: 27px;padding-right: 27px;"></i></a>
                                            <a href="../../views/process/admin_process.php?move_user_owner=<?php echo $data->user_id ?>"title="Delete" <i class=" btn btn-danger far fa-window-close" aria-hidden="true" style="padding-left: 27px;padding-right: 27px;"></i></a>
                                        </td>
                                    </tr>
