                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table id="sohag1" class="table table-bordered table-hover">
                            ...
                            <?php
                            $datas = $datamanipulation->viewAllUserTOWork();
                            if($datas){
                                $s=1;
                                foreach ($datas as $data){
                                    ...
                                    <tr>
                                        <td><?php echo $s?></td>
                                        <td class="attrName"><?php echo $data->name?><span class="message-show-on-alert badge-danger badge ml-2"></span></td>
                                        <td><?php echo $data->phone?></td>
                                        <td><?php echo $data->email?></td>
                                        <td><?php echo $data->profession?></td>
                                        <td class="text-center">
                                            <a data-id="<?php echo $data->user_id?>" class="btn bg-danger btn-outline-success attrValue show-chat-box-click" ><i class="fa fa-trash"></i> Chat</a>
                                            <a href="user_profile.php?view_building_woner_profile_by_email=<?php echo $data->user_id ?>" title="View Profile" <i class=" btn btn-success far fa-eye-slash" aria-hidden="true"></i></a>
                                        </td>
                                    </tr>
