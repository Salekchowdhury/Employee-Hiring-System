...
<body style="position: relative" class="hold-transition sidebar-mini">
<div class="wrapper">
    ...
    <aside style="background-color: rgba(116,12,41,0.6);position: fixed" class="student-bg main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <?php
                $userData = $datamanipulation->showUserProfile($email);
    ...
    <div class="content-wrapper">
        ...
        <div class="magic-show " style="display: none; position: absolute; right: 0px; bottom: 0; width: 81%;background: rgba(23,23,23,0.56) ;min-height: 120px ">
            <span class=" d-flex justify-content-end">
                <i style="cursor: pointer" class="comment-close p-2 fa fa-times"></i>
            </span>
            <div style=""><textarea class="form-control col-sm-12 ml-5 mt-0 comment-box-message" style="width: 90%;resize: none"placeholder="Please write your comments"></textarea>
                <input type="button" class="form-control col-sm-12 ml-5 mt-0 btn btn-danger comment-box-btn " style="width: 90%"value="Comments">
            </div>
        </div>
        <div class="temp"></div>
        <footer>
